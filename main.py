...
def count_down(count):
    ...
    if count > 0:
        ...
        for x in range(work_sessions):
            check_marks += "✔"
        tick_marks.config(text=check_marks)
...
# Reset button
start_button = Button(text="Reset", width=5, font=(FONT_NAME, 12, "bold"), command=reset_timer)
start_button.grid(column=2, row=2)

# ✔ marks
tick_marks = Label(bg=YELLOW, fg=GREEN, font=(FONT_NAME, 16, "bold"))
